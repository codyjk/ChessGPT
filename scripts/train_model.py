...
DEFAULT_NUM_HEADS = 4
DEFAULT_SHOW_RANDOM_BASELINE = False
...
def main():
    ...
    tokenizer = ChessTokenizer.load(args.tokenizer_file)
...
def build_arg_parser():
    ...
    parser.add_argument(
        "--tokenizer-file",
        type=str,
        help=f"The tokenizer file, as generated by `fit-and-save-tokenizer`. Defaults to {DEFAULT_TOKENIZER_FILE}",
        required=False,
